...
//        registroThread.start();
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                fucionalidadeConsole.limparConsole();
                utilitarios.mensagemInformativa();
                System.out.println("Deseja visualizar o histórico de bloqueios? (s/n)");
                String opcao = sc.next();

                if (opcao.equalsIgnoreCase("s")) {
                    for (HistoricoBloqueios historicoDaVez : daoJanelasBloqueadas.visualizarHistoricoBloqueados(maquina)) {
                        System.out.println(historicoDaVez);
                    }

                } else if (opcao.equalsIgnoreCase("n")) {
                    System.out.println("Caso queira visualizar o histórico de bloqueios, acesse o sistema web.");
                    } else {
